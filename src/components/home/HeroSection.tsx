...
export function HeroSection() {
  return (
    <section className="relative w-full min-h-screen overflow-hidden !py-0">
       ...
       * matching the screenshot's airy sky feel.
       */}
       ...
       * of the viewport, matching the screenshot's asymmetric composition.
       */}
       ...
       * Matches the screenshot's white card with stats in a horizontal row.
       */}
